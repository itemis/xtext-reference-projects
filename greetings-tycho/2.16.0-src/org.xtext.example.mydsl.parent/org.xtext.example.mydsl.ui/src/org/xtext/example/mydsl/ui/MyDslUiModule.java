...
public class MyDslUiModule extends AbstractMyDslUiModule {
	...
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return super.bindAbstractValidatorConfigurationBlock();
	}
	...
	public Class<? extends ICopyQualifiedNameService> bindICopyQualifiedNameService() {
		return super.bindICopyQualifiedNameService();
	}
	...
	public void configureSpellChecker(Binder binder) {
		super.configureSpellChecker(binder);
	}

	@Override
	public Class<? extends IBuildPreferenceEvaluator> bindIBuildPreferenceEvaluator() {
		return super.bindIBuildPreferenceEvaluator();
	}
